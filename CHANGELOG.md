...
## [v9.0.0](https://github.com/nextcloud-libraries/eslint-config/tree/v9.0.0) (2025-11-07)
...
* Updated `@stylistic/eslint-plugin` 5.5.0
* Updated `eslint-plugin-jsdoc` to 61.1.12
* Updated `eslint-plugin-vue` to 10.5.1
* Updated `fast-xml-parser` to 5.3.1
* Updated `sort-package-json` to 3.4.0
* Updated `typescript-eslint` to 8.46.2
