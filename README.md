...
- fixes cause a patch version bump.
- enhancements cause a minor version bump.
- breaking changes cause a major version bump.
...
If those rule are code style related, the matching section of the [Nextcloud developer documentation](https://github.com/nextcloud/documentation/) has to be updated to keep both in sync.
